...
def find_loc_san(d,ori_y,ori_x,san_y,san_x):
    ...
    for loc in range(len(d)):
        ...
        if in_range(oy,ox) and (arr[oy][ox]==0 or arr[oy][ox]==-1):
    ...
    if ((san_y - ry) ** 2) + ((san_x - rx) ** 2) < min_loc[0]:
        to_return=(-1,-1)
    # if arr[to_return[0]][to_return[1]] !=0 and arr[to_return[0]][to_return[1]] !=-1 :
    #     to_return=(-1,-1)
        ...
        if (sy,sx) == (-1,-1):
            ...
            for idx_p in range(p):
                if (player_arr[idx_p][1], player_arr[idx_p][2]) == (y, x):
                    ...
                    ppp = player_arr[idx_p][0]
            if in_range(to_y, to_x) and (arr[to_y][to_x] != 0):
                if arr[to_y][to_x] != ppp:
                ...
                for i in range(p):
                    if player_arr[i][0] == ppp:
                        ...
                        arr[to_y][to_x] = ppp
                        player_arr[i][1], player_arr[i][2] = to_y, to_x
            elif in_range(to_y, to_x) and arr[to_y][to_x] == 0:
                for i in range(p):
                    if player_arr[i][0] == ppp:
                        arr[y][x] = 0
                        arr[to_y][to_x] = ppp
